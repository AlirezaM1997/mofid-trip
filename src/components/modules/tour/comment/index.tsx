...
const TourComment = () => {
  ...
  const handleNavigateToComment = () => router.push(`tour/${tourId}/comment`);
      ...
      <Container style={styles.containerStyle}>
        ...
        <Pressable onPress={handleOpen} style={styles.commentAddStyle}>
          <View style={styles.commentAddBox}>
            <View style={styles.commentAddText}>
              ...
              <Text body2>{tr("write your opinion about this tour")}</Text>
            </View>
        ...
        {comment?.length === 0 ? (
          <View style={styles.noResultStyle}>
            ...
            <Text body2>
              {tr("there are no comments yet. be the first to write your opinion about this tour")}
            </Text>
          </View>
        ) : (
