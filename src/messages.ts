export const messages = {
  "about mofidtrip": {
    ar: "عن المفیدتریب",
    fa_ir: "درباره مفیدتریپ",
    en_us: "About Mofidtrip",
  },
  "absolutely free offers": {
    ar: "عروض مجانية تماما",
    fa_ir: "رایگان",
    en_us: "Absolutely Free Offers",
  },
  "account detail": {
    ar: "تفاصيل الحساب",
    fa_ir: "جزئیات حساب",
    en_us: "Account Detail",
  },
  "add guest": {
    ar: "إضافة شخص",
    fa_ir: "افزودن مهمان",
  ...
  "are you sure to cancel?": {
    ...
    fa_ir: "آیا مطمئن هستید که لغو می کنید؟",
    en_us: "Are You Sure To Cancel?",
  },
  back: {
    ar: "إعادة ضبط",
    fa_ir: "بازگشت",
  ...
  "click the button to book now and go through the process": {
    ar: "انقر فوق الزر الحجز الآن وتابع العملية",
    fa_ir: "روی دکمه رزرو کلیک کنید و مراحل را طی کنید.",
    en_us: "Click The Button To Book Now And Go Through The Process",
  },
  "coming soon": {
    ar: "قريباً",
    fa_ir: "به زودی",
  ...
  "our free offers in different cities of the world": {
    ar: "عروضنا المجانية في مدن مختلفة من العالم",
    fa_ir: "پیشنهادات رایگان ما",
    en_us: "Our Free Offers In Different Cities Of The World",
  },
  "passport number": {
    ar: "رقم جواز السفر",
    fa_ir: "شماره پاسپورت",
  ...
  "this section is under development and will be available in the next update.": {
    ...
    en_us: "This Section Is Under Development And Will Be Available In The Next Update.",
  },
  "total amount": {
    ar: "المبلغ الإجمالي",
    fa_ir: "مبلغ کل",
  ...
  "travel duration": {
    ar: "مدة السفر",
    fa_ir: "مدت سفر",
    en_us: "Travel Duration",
  },
  "trending place": {
    ar: "مكان شائع",
    fa_ir: "پر طرفدار ها",
    en_us: "Trending Place",
  },
  upload: {
    ar: "قم بتحميل صورة جواز السفر",
    fa_ir: "ارسال فایل",
    en_us: "Upload",
  },
  verification: {
  ...
  "invalid passport number": {
    ar: "رقم جواز السفر غير صالح",
    fa_ir: "شماره پاسپورت نامعتبر",
    en_us: "Invalid Passport Number",
  },
  "i confirm the above content and agree to the rules and regulations of the app": {
    ar: "أؤكد المحتوى أعلاه وأوافق على قواعد وأنظمة التطبيق",
    fa_ir: "من محتوای فوق را تایید می کنم و با قوانین و مقررات برنامه موافقم",
    en_us: "I Confirm The Above Content And Agree To The Rules And Regulations Of The App",
  },
  "are you sure to finalize reservation?": {
    ar: "هل أنت متأكد من إنهاء الحجز؟",
    fa_ir: "آیا مطمئن هستید که رزرو را نهایی می کنید؟",
    en_us: "Are You Sure To Finalize Reservation?",
  },
  "no, cancel": {
    ar: "لا، إلغاء",
    fa_ir: "نه، لغو",
  ...
  "no more data": {
    ...
    fa_ir: "چیز بیشتری نیست",
    en_us: "No More Data",
  },
  "loading ...": {
    ar: "تحميل ...",
    fa_ir: "در حال بارگذاری ...",
    en_us: "Loading ...",
  },
  "fetch more": {
    ar: "جلب المزيد",
  ...
  contact_the_place: (name: string) => ({
    ar: "اتصل بالمكان",
    fa_ir: `با ${name} تماس بگیرید`,
    en_us: "Contact the place",
  }),
  you_can_contact_the_owner_of_the_place_through_the_following_social_networks_or_directly: (name: string) => ({
    ar: `يمكنكم التواصل مع ${name} عبر شبكات التواصل الاجتماعي التالية أو مباشرة`,
    fa_ir: `می توانید از طریق شبکه های اجتماعی زیر و یا مستقیما با ${name} تماس بگیرید`,
    en_us:
      `You can contact the ${name} through the following social networks or directly`,
  }),
  ...
  "are you sure you want to logout?": {
    ...
    fa_ir: "آیا از خروج خود مطمئن هستید؟",
  ...
  "by clicking the registration button, you agree to mofidtrip rules and regulations.": {
    ...
    en_us: "By clicking the registration button, you agree to Mofidtrip rules and regulations.",
  },
  "identify number": {
    ar: "تحديد الرقم",
    fa_ir: "کد ملی",
